...
void TestStringUtils::formatCountNumber_millions() {
  QCOMPARE(StringUtils::formatCountNumber(1234567),
           QStringLiteral("1,234,567"));
  QCOMPARE(StringUtils::formatCountNumber(10000000),
           QStringLiteral("10,000,000"));
}

void TestStringUtils::formatCountNumber_billions() {
  QCOMPARE(StringUtils::formatCountNumber(1000000000LL),
           QStringLiteral("1,000,000,000"));
}
...
void TestStringUtils::formatCountNumber_negativeThousands() {
  ...
  QCOMPARE(StringUtils::formatCountNumber(-1000000),
