...
void TestGridUtils::testCalculateGridMetrics_basicGrid() {
  ...
  // 3 rows
  GridUtils::calculateGridMetrics(12, 4, 200, 100, 10, 10, 20, totalWidth, totalHeight,
                                  actualGridWidth);
...
void TestGridUtils::testCalculateGridMetrics_singleColumn() {
  ...
  GridUtils::calculateGridMetrics(5, 1, 100, 100, 10, 10, 10, totalWidth, totalHeight,
                                  actualGridWidth);
...
void TestGridUtils::testCalculateGridMetrics_emptyGrid() {
  ...
  // 0 items
  GridUtils::calculateGridMetrics(0, 4, 100, 100, 10, 10, 10, totalWidth, totalHeight,
                                  actualGridWidth);
...
void TestGridUtils::testCalculateGridMetrics_minimumDimensions() {
  ...
  GridUtils::calculateGridMetrics(1, 10, 100, 100, 5, 5, 5, totalWidth, totalHeight,
                                  actualGridWidth);
