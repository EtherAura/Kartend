/****************************************************************************
** Meta object code from reading C++ file 'sidebarmanager.h'
**
...
#include "../../../../src/managers/sidebarmanager.h"
...
#error "The header file 'sidebarmanager.h' doesn't include <QObject>."
...
template <> constexpr inline auto SidebarManager::qt_create_metaobjectdata<qt_meta_tag_ZN14SidebarManagerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'sidebarVisibilityChanged'
        QtMocHelpers::SignalData<void(bool)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Bool, 3 },
        }}),
        // Signal 'sidebarLayoutChanged'
...
void SidebarManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->sidebarVisibilityChanged((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 1: _t->sidebarLayoutChanged(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SidebarManager::*)(bool )>(_a, &SidebarManager::sidebarVisibilityChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SidebarManager::*)()>(_a, &SidebarManager::sidebarLayoutChanged, 1))
            return;
    }
}
...
// SIGNAL 0
void SidebarManager::sidebarVisibilityChanged(bool _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void SidebarManager::sidebarLayoutChanged()
{
