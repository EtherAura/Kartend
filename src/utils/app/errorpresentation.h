...
/// modules/data/settings/settingsmanagercollections.cpp) call these instead
/// of reaching upward into src/ui/dialogs/errordialog.h, keeping the
/// documented layering DAG intact. The implementation lives in src/ui/dialogs/
/// and forwards to ErrorDialog::showError / showCriticalError (Kartend-ncot).
