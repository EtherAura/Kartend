...
// persistence.
//
// This TU keeps lifecycle (ctor/dtor/shutdown snapshots), the lookup and
// insert paths, and collection-scoped invalidation. Sibling TUs (same
// class, partial-split pattern):
//   cachemanagerdisk.cpp        — debounced disk-persistence orchestration
//   cachemanager_maintenance.cpp — disk-size walk, budget eviction,
//                                  stale-entry GC, metrics
