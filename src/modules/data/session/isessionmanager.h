...
public:
  ...
  virtual void setLastSelected(const QString &collectionName, int index,
  ...
  virtual void setCollectionCounts(const CollectionConfig &collection,
                                   ...
                                   qint64 itemCount, qint64 recursiveCount) = 0;
  ...
  [[nodiscard]] virtual CachedViewport
  getCachedViewport(const QString &collectionKey) const = 0;
