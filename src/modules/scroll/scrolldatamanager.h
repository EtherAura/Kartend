 ...
 * 
 * This class encapsulates the data storage and initialization logic that was previously
 * scattered throughout ScrollManager, providing a cleaner separation of concerns.
 */
