...
public:
   ...
   * @return true if state was saved, false if already had saved state or no widgets
   */
   ...
   * 
   * @param activeWidgets Current search result widgets (will be cleared and replaced)
