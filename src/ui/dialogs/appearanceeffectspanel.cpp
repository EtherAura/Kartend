...
void AppearanceEffectsPanel::load(const CollectionConfig &config) {
...
void AppearanceEffectsPanel::save(CollectionConfig &config) const {
...
bool AppearanceEffectsPanel::hasChanges(const CollectionConfig &o) const {
