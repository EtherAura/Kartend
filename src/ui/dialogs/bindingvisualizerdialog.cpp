...
QList<BindingRow> buildBindings(const GeneralSettings &gs) {
  return {
      {QObject::tr("Navigation"), QObject::tr("Move left"), gs.keyNavLeft, QString()},
      {QObject::tr("Navigation"), QObject::tr("Move right"), gs.keyNavRight, QString()},
      {QObject::tr("Navigation"), QObject::tr("Move up"), gs.keyNavUp, QString()},
      {QObject::tr("Navigation"), QObject::tr("Move down"), gs.keyNavDown, QString()},
      {QObject::tr("Navigation"), QObject::tr("Jump to first"), gs.keyJumpFirst, QString()},
      {QObject::tr("Navigation"), QObject::tr("Jump to last"), gs.keyJumpLast, QString()},
      {QObject::tr("Navigation"), QObject::tr("Alphabetic back"), gs.keyAlphabeticBack, QString()},
      {QObject::tr("Navigation"), QObject::tr("Alphabetic forward"), gs.keyAlphabeticForward,
       QString()},
      {QObject::tr("Navigation"), QObject::tr("Go to Home view"), gs.keyHomeView, QString()},
      {QObject::tr("Actions"), QObject::tr("Confirm / launch"), gs.keyConfirm,
       gs.gamepadConfirmButton},
      {QObject::tr("Actions"), QObject::tr("Back / cancel"), gs.keyBack, gs.gamepadBackButton},
      {QObject::tr("Actions"), QObject::tr("Open item details"), gs.keyItemDetails, QString()},
      {QObject::tr("Actions"), QObject::tr("Toggle sidebar"), 0, gs.gamepadToggleSidebarButton},
      {QObject::tr("Search"), QObject::tr("Open search"), gs.keySearch, QString()},
  };
}
