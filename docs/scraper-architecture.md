...
after-crash) see [Scraper](guide/Scraper.md).
...
- Honors the **rescrape mode** (`Overwrite`, `FillMissing`,
  ...
  [Configuration Reference](guide/Configuration-Reference.md#scraperoptions--global-scraper-performance--behavior).
...
8. **Document the credentials** in
   [docs/guide/Scraper.md](guide/Scraper.md) (user-facing) and
   [docs/guide/Keychain.md](guide/Keychain.md) (storage).
...
| User docs | [docs/guide/Scraper.md](guide/Scraper.md) |
