...
(See the [clang-format v19 pin](../../CONTRIBUTING.md) feedback note.)
...
[tests/suppressions/lsan.txt](../../tests/suppressions/lsan.txt) carry workaround
...
| Sanitizer suppressions | [tests/suppressions/tsan.txt](../../tests/suppressions/tsan.txt), [tests/suppressions/lsan.txt](../../tests/suppressions/lsan.txt) |
