...
[Item-Metadata → DAT-file identification](../user/Item-Metadata.md#dat-file-identification-rom-collections);
the scrape integration is in
[Scraper](../user/Scraper.md).
...
| User docs | [Item-Metadata → DAT-file identification](../user/Item-Metadata.md#dat-file-identification-rom-collections) |
