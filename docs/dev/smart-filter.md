...
The smart-filter DSL is what backs [Smart Playlists](../user/Smart-Playlists.md).
...
[Smart Playlists guide](../user/Smart-Playlists.md).
...
| Context-menu entries | [src/modules/input/interaction/interactionmanager_contextmenu.cpp](../../src/modules/input/interaction/) |
| User docs | [docs/user/Smart-Playlists.md](../user/Smart-Playlists.md) |
