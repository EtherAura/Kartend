...
See [docs/dev/subfolder-artwork.md](../dev/subfolder-artwork.md) for the
...
a rebuild. See [docs/dev/constants.md](../dev/constants.md).
...
[building.md](../dev/building.md). Quick pointers:

| Issue | Doc |
|-------|-----|
| Missing Qt6 / dependencies | [building.md](../dev/building.md) |
...
| CI passes locally but fails on GitHub | [building.md → CI parity](../dev/building.md) |
...
- [Building](../dev/building.md) — build dependencies, common build errors
