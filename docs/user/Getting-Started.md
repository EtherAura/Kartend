...
After installing (see [building.md](../dev/building.md)) launch Kartend from
...
- [building.md](../dev/building.md) — building from source
- [architecture.md](../dev/architecture.md) — how Kartend is structured
  internally
