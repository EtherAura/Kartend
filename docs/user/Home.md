...
- **[Launcher Import](Launcher-Import.md)** — build collections from the
  games already installed through Steam, Flatpak, Lutris, Heroic, itch.io,
  Bottles, or your application menu, with their existing artwork and
  on-demand re-sync
...
- **[Architecture](../dev/architecture.md)** — module layout, manager
  ownership, threading model, signal flow
- **[Building](../dev/building.md)** — dependencies, build script,
  CMake options
- **[Testing](../dev/testing.md)** — unit and integration tests
- **[Constants](../dev/constants.md)** — `UIConstants` reference
- **[Seed data](../dev/seed-data.md)** — generating test libraries
- **[Subfolder artwork generator](../dev/subfolder-artwork.md)** — placeholder
