...
[Configuration Reference](guide/Configuration-Reference.md). High-
...
| [docs/guide/Configuration-Reference.md](guide/Configuration-Reference.md) | A row in the right section |
...
[docs/guide/Configuration-Reference.md](guide/Configuration-Reference.md)
...
- **Secret keys** — Don't add credentials to the regular settings
  ...
  layer; see [Keychain](guide/Keychain.md) and
...
| Wiki documentation | [docs/guide/Configuration-Reference.md](guide/Configuration-Reference.md) |
